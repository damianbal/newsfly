...
@section('title_head') Index @endsection
...
<nav class="nav nav-pills nav-fill">
    ...
    <a data-toggle="tooltip" title="Send news now, instead of sunday" class="nav-item nav-link" href="{{ route('news-send') }}"><i class="fas fa-envelope"></i> Send News</a>
